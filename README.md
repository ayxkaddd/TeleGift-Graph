...
- Export loaded data as JSON, TXT, or CSS

## Get API key
1. Visit https://telelog.org/
2. Go to the Telegram bot, type /api and create a token.

## Run

1. Open https://ismokeweed.xyz/TeleGift-Graph/ in a browser or clone the repo and open `index.html`.
2. Enter your API key when prompted.
3. Enter a user ID and click `Load Graph`.
